...
namespace Generic_WFA.Functions
{
    ...
    /// <summary>
    /// Summary description for CryptographyRijndael
    /// </summary>
    public class CryptographyRijndael
    {
        ...
        //known as SHA-256 and SHA-512. They differ in the word size; SHA-256 uses 32-bit words 
        //where SHA-512 uses 64-bit words. There are also truncated versions of each standardized, 
        //known as SHA-224 and SHA-384. These were also designed by the NSA.
        private static string DEFAULT_SECURE_HASH_ALGORITHM = "SHA256";

        //key size determines the "strength" of encryption
        private static int ENCRYPTION_KEY_SIZE = 256;
        ...
        public CryptographyRijndael()
        {
            //
            // TODO: Add constructor logic here
            //
        }
        public CryptographyRijndael(string passPhrase)
                               ...
                               int passwordIterations)
        {
            ...
            // not use dashes, e.g. change "sha-256" to "SHA256".
            if (hashAlgorithm == null)
                hashAlgorithm = DEFAULT_SECURE_HASH_ALGORITHM;
            else
        ...
        {
            return Encrypt(Encoding.Default.GetBytes(plainText));
        }
        ...
        {
            return EncryptToBytes(Encoding.Default.GetBytes(plainText));
        }
        ...
        {
            return Encoding.Default.GetString(DecryptToBytes(cipherTextBytes));
        }
